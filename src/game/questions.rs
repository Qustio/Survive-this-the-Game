...
impl Questions {
    pub fn new() -> Questions {
        Questions {
            list: vec![
                Question {
                    text: "Ваш взгляд устремлён на неопознанное животное, затаившиееся в кустах. Ваша логика твердит вам о том, что его дикие инстинкты закончат ваше жалкое существование, но всё же вы не можете отказать себе в том,  развеять ещё одну тайну в данном лесу.\
                    Подойти к животному?",
